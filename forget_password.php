...
<head>  
  <meta charset="utf-8" />
  <title>Classified :: Recover password</title>
...
<body>
										...
										<form id="verify_form">
											<div id="first_set">
												<div class="panel-body"><br/>
													...
													<div class="row">
														<div class="col-sm-12">
															<label style="margin-left:15px"><span><b>Enter your email to reset your password</b></span></label><br/>
															<div id="errors1_msg" class="req" style="margin-left:15px"></div>
															<div class="col-sm-12">
																<input type="text"  class="form-control input-lg" placeholder="Your email address" name="email_rec" id="email_rec">
															</div>
														</div>
													</div>
													<div class="row"><br/>
														<div class="col-sm-12">
															<div class="col-sm-12">
																<div class="alert alert-danger">
																	You need to check your email to activate your account
																</div>
															</div>
														</div>
													</div>	
													<div class="row"><br/>
														<div class='col-sm-12'>
															<div class='col-sm-12'>
																<button type="button" class="btn btn-info form-control btn-lg" onclick="password_rec()" style="margin-right:15px">SUBMIT</button>
															</div>
														</div>
													</div>													
												</div>
  ...
  <script>
	function password_rec()
	{
		...
		if(email=="")
		{
			document.getElementById("email_rec").style.border="1px solid red";
		}
		else
		{
			//Make a post call
