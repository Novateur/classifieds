...
<body onload="organize_order()">
						...
						<div class="container">
							...
							<div class="col-sm-6">
									<div class="panel b-a" style="padding:20px">								
										...
										<div class="row"><br/>
											<div class="col-sm-12">
												<div id="advert_section">
													<p>Choose a colour scheme</p>
													<span class='radio i-checks'>
													  <label>
														<input type='radio' name='colour'>
														<i></i>
															Colour (charges may apply)
													  </label>
													</span>
													...
													<p>Upload your advert image(if no advert image visit <a href='http://www.printanything.ng'>Printanything.ng</a> for design samples)</p>
													<div id="img_msg"></div>
													<input type="file" name="file1" id="file1" class="form-control" value="bun_2.jpg"onchange="PreviewFile()"/>
												</div><br/>
												<div id="advert_preview">
													<img src="" width="120" height="150" style="border:2px solid black"  id="pro"/>
												</div>
												<div id="paste_info">
												</div>
											</div>
  ...
  <script>
	...
	function organize_order()
	{
		...
		{
			var info="<p><b>Selected dates</b></p>";
			var dates = new Array();
